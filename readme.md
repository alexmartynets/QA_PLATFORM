...
- **сount** - счетчик правок;
- **user** - идентификационный номер пользователя, сделавшиго правку;
```
Сущность, отслеживающая количество правок внесенных пользователем.
```
...
- **persistDateTime** - дата публикации вопроса;
- **сount** - счетчик репутации;
- **user** - идентификационный номер пользователя, получивший репутацию;
```
Сущность, отслеживающая репутацию пользователей. 
...
- **persistDateTime** - дата назначения;
- **user** - идентификационный номер пользователя, назначенный модератором;
```
Сущность, определяющая кто является модератором.
```
...
- **countValuable** - счетчик “полезности” вопроса, т. е. сколько пользователей посчитали вопрос полезным,
отметив его;
