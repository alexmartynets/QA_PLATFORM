function getTextOfQuestion(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            tableBody.empty();
            $(data).each(function (index, val) { if(val.id == x){
                tableBody.append(`<tr>
        <td width="50" rowspan="2"><button class=" btn btn-link- outline-dark"
                                                    title="Ответ полезен">
                                            ...
                                            <div class=" ml-3 " id="countValuableAnswer">1</div>

                                            <button class="btn btn-link- outline-dark"
    ...
    <tr>
         <td  style="background-color: gainsboro">${val.htmlBody}</td>
    </tr>
    <tr>
        <td colspan="2"><button type="button" class="btn btn-link" data-container="body"
                                    ...
                                    <span style="text-align:right;float:right; background-color: #e1ecf4"
                                          class="badge badge"><h>ответ дан</h><h class=" ml-1 "
                                                                                 id="AnswerPersistDateTimeUser"></h><div><svg
                                            ...
                                            class=" ml-1 "
                                            id="AnswerInfoUser"></h></div></span></td>
    </tr>`);
            }})
