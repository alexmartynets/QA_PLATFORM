...
//     // console.log(url);
//
//     console.log("attr_search при загрузке страницы по кнопке репутация в начале кода");
//     console.log(attr_search);
//
...
//             weeks = $('#month').attr("data-weeks");
//
//             console.log("attr_search в блока search-users при нажатии кнопки ПОИСКА в блоке else");
//             console.log(attr_search);
//
//             // url для запроса
//             // console.log("URL блок search-users при нажатии кнопки ПОИСКА в блоке else");
//             // console.log(url + numberMedia + "&page=" + currentPage + "&weeks=" + weeks);
//
//         }
//
...
//         // console.log(url + numberMedia + "&page=" + currentPage + "&weeks=" + weeks);
//
//         console.log("attr_search в конце блока search-users при нажатии кнопки ПОИСКА перед dataMap");
//         console.log(attr_search);
//
...
//         console.log(text);
//
//         console.log("attr_search при нажатии кнопки СОРТИРОВКА блока sorting-time начало");
//         console.log(attr_search);
//
...
//         // console.log(url + numberMedia + "&page=" + currentPage + "&weeks=" + weeks);
//
//         console.log("attr_search в конце блока sorting-time перед dataMap");
//         console.log(attr_search);
//
//         // получаем даннные для текущей страницы
//         let dataMap = data.getListUsers(url + numberMedia + "&page=" + currentPage + "&weeks=" + weeks);
...
//     // console.log(url + numberMedia + "&page=" + currentPage + "&weeks=" + weeks);
//
//     console.log("attr_search при загрузке страницы по кнопке блока перед пагинацией и dataMap");
//     console.log(attr_search);
//
//     let dataMap = data.getListUsers(url + numberMedia + "&page=" + currentPage + "&weeks=" + weeks);
//     service.showUsers(data, dataMap);
...
//         // console.log(url + numberMedia + "&page=" + currentPage + "&weeks=" + weeks);
//
//         console.log("attr_search в блоке пагинация");
//         console.log(attr_search);
//
//         let dataMap = data.getListUsers(url + numberMedia + "&page=" + currentPage + "&weeks=" + weeks);
//         service.showUsers(data, dataMap);
